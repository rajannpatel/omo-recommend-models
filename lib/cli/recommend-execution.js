...
function createModelAllowedPredicate(allowedPaidModels, rejectedPaidModels) {
...
export async function selectRecommendation({
  ...
  try {
    ...
    const isModelAllowed = createModelAllowedPredicate(allowedPaidModels, rejectedPaidModels);
    return {

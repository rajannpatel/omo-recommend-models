...
import { providerState } from "../probe-providers.js";
...
async function enhanceCloudRecommendationsWithMatchingPipeline(cloudRecommendations, isProviderAllowed) {
...
export async function applyRecommendations({
  ...
  console.log(`  Backup: ${getBackupPath({ global: isGlobal })}`);

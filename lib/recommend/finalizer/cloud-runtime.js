...
import { bestCloudRecommendationForProvider, cloudRecommendationsForProvider } from "./cloud.js";
...
export function addMissingCloudFallbacks(
  ...
  for (const [provider, modelMap] of cloudProviders) {
    ...
    const fallbacks = cloudRecommendationsForProvider(
      provider,
      modelMap,
      cloudLookup,
      isModelAllowed,
    ...
    rec.fallback_models.push(...fallbacks);

export const MODEL_REQUIREMENTS_SOURCE = {
...
export const AGENT_MODEL_REQUIREMENTS = {
  sisyphus: {
    fallbackChain: [
      ...
      { providers: ["opencode", "bailian-coding-plan", "moonshotai", "moonshotai-cn", "firmware", "ollama-cloud", "aihubmix", "vercel"], model: "kimi-k2.5" },

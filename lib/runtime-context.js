...
export class RuntimeContext {
  constructor() {
    ...
    this.policyExclusionCache = null;
    this.providerProbePromises = new Map();
    this.disposeSignalHandlers = null;
  }
  ...
  installSignalHandlers() {
    if (this.disposeSignalHandlers) return this.disposeSignalHandlers;
    ...
    return this.disposeSignalHandlers;
  }

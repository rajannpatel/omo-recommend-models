...
export function detectFamilyFromMeta(meta, modelName) {
...
export function scoreModelFromMeta(model, variant, meta) {
...
export function scoreFromCache(model, variant, entry) {
  return scoreModelFromMeta(model, variant, entry);
}

export function scoreFromHeuristics(model, variant) {
...
export function panelModelOrder(config) {
